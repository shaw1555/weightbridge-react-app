...
//   onSubmit: () => void;
//   weighGateInOutData: WeighVGM;
//   setWeighGateInOutData: React.Dispatch<React.SetStateAction<WeighVGM>>;
//   updateGateChargeAmount: (data: WeighVGM) => void;
//   updateWeightChargeAmount: (data: WeighVGM) => void;
// }
...
//   const [gateInOutInfos, setGateInOutInfos] = useState<VGMGateInOutInfo[]>([]);
